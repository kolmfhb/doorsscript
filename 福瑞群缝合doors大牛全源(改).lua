...
if a=="Manpo150"then
_G.she=true
elseif a=="Shhsjsjak0"then
_G.she=true
elseif a=="nmjddxd"then
_G.she=true
elseif a=="yigemengxina"then
_G.she=true
elseif a=="leo_himskl"then
_G.she=true
...
Key.PlaceholderText = "作者qq(114514xhxh"
Key.Text = ""
...
player:AddParagraph("提示","作者得上学，不定时更新（确信）")
player:AddParagraph("答辩","作者114514xhxh")
...
player:AddParagraph("NO.1","耗子(40元)【用40元买了刷怪菜单】")
player:AddParagraph("NO.2","😡😡😡(15元)【用15买了透视】")
player:AddParagraph("声明：","首先，感谢对中转站的支持！所有的钱用来更新中转站！所以不要说我⭕️！免费脚本，只是赞助！！！")
